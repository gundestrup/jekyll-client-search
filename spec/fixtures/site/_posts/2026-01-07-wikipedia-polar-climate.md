...
Otto Nordenskjöld theorized that winter conditions also play a role: His formula is W = 9 − 0.1 C, where W is the average temperature in the warmest month and C the average of the coldest month, both in degrees Celsius. For example, if a particular location had an average temperature of −20 °C (−4 °F) in its coldest month, the warmest month would need to average 11 °C (52 °F) or higher for trees to be able to survive there as 9 − 0.1(−20) = 11. 
