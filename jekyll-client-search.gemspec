...
Gem::Specification.new do |spec|
  ...
  spec.description = "A Jekyll plugin that generates a configurable JSON search index with pluggable " \
                     "browser runtime adapters for client-side JavaScript search engines."
