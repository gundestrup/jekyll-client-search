...
tags: ["technology", "satellite", "communication", "gear"]
source: "Wikipedia — The Free Encyclopedia"
source_url: "https://en.wikipedia.org/wiki/Satellite_phone"
...
Satellite phones can be used in areas where conventional communication infrastructure is unavailable or has been disrupted. Applications include maritime and aviation communication, remote expeditions, logistics, and emergency response.
...
== Satellite networks ==
Satellite telephony systems operate mainly through two orbital types: geostationary orbit (GEO), about 35,786 kilometres (22,236 mi) above Earth, and low Earth orbit (LEO), about 640 to 1,120 kilometres (400 to 700 mi).  
...
History of the handheld satellite phone (GlobalCom, 2018)
University of Surrey – Satellite constellations overview
Satellite phone FAQ (technical overview)
